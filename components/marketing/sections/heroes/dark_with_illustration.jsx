            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div className="lg:py-24">
                  ...
                  We are committed to delivering innovative and cutting-edge solutions to help businesses thrive in the digital era. Our team of experienced engineers and developers are dedicated to building scalable, secure, and high-performing software applications.
                  </p>
