...
const blogPosts = [
  {
    ...
    preview:
      'Software development is the backbone of any successful digital business. By developing intuitive and user-friendly applications, you can provide a seamless experience that attracts and retains customers.',
    author: {
  ...
  },
  {
    ...
    preview:
      'Real-Life Example: GPT-3.5 Turbo proved instrumental in revolutionizing customer support in the e-commerce industry. An online retailer integrated this framework to automate their customer service chatbot. ',
    author: {
      name: 'Brenna Goyette',
      imageUrl:
  ...
  },
  {
    ...
    preview:
      'ChatGPT prompt frameworks have demonstrated their prowess in revolutionizing industries far and wide. Let\'s explore a couple more examples to inspire and illustrate their transformative potential',
    author: {
      name: 'Daniela Metz',
      imageUrl:
            ...
            >
              <div className="flex items-center flex-1">
                <div className="flex items-center justify-between w-full md:w-auto">
                  <a href="#">
                    <span className="sr-only">D8</span>
                    <img
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    ...
                    >
                      ...
                      <span className="ml-4 text-sm">Create your account now</span>
                    ...
                    Leverage the power of artificial intelligence and machine learning to unlock valuable insights and drive intelligent decision-making in your business processes. Our team specializes in developing AI and ML solutions that enhance efficiency, accuracy, and automation.
                    </p>
          ...
          <div className="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1">
                <img
                  className="h-10"
                  src="https://meetlily.d8me.live/logo.svg"
                  alt="D8 Community"
                />
            ...
            <div className="mt-12 border-t border-gray-200 py-8">
              <p className="text-base text-gray-400 xl:text-center">&copy; 2023 D8 Community All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
